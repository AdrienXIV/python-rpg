...
while True:  # Boucle infini
    type_personnage = input(
        'Entrez votre type (- Guerrier => 1 - Voleur => 2 - Mage => 3):')
...
while True:  # Boucle infini
    ethnie = input(
        'Entrez votre ethnie ("Congo", "Mongolie", "France", "USA", "Japon", "Cote_Ivoire", "Argentine", "Haiti", "Angleterre"):')
    ethnie = ethnie.strip()
...
while True:  # Boucle infini
    sexe = input(
        'Entrez votre sexe (- Homme => 1 - Femmme => 2 - Trans => 3):')

...
class Item():
    ...
    def __init__(self, level, type_personnage):
        ...
        if self.objet["catg"] == 1:  # Si object de type attaque
            self.attaque = (
                1+(2 if type_personnage == self.objet['type_personnage'] else 1)/100)+chance/100
            ...
            self.chance = (1+(2 if type_personnage ==
                              self.objet['type_personnage'] else 1)/100)+chance/100
        elif self.objet["catg"] == 5:
            self.mana = (1+(2 if type_personnage ==
                            self.objet['type_personnage'] else 1)/100)+chance/100
        elif self.objet["catg"] == 6:
            self.vie = (1+(2 if type_personnage ==
                           self.objet['type_personnage'] else 1)/100)+chance/100
